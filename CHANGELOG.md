...
- автообпределение пути до платформы в зависимости от системы linux/windows (достаточно указать версию платформы)
- relative path для Configuration.xml и для папки с конфигурационными файлами для запуска 1С
